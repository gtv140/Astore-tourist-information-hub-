...
body{font-family:'Poppins',sans-serif;color:#fff;background:#000;overflow-x:hidden;transition:0.5s;}
.bg-animate{position:fixed;width:100%;height:100%;background:linear-gradient(270deg,#000,#001f3f,#000,#0f0f0f);background-size:800% 800%;animation:gradientBG 20s ease infinite;z-index:-3;}
...
.container{max-width:1100px;margin:80px auto;padding:30px;background:rgba(0,0,0,0.4);border-radius:20px;backdrop-filter:blur(10px);box-shadow:0 0 25px #00eaff;}
...
#dashboard{max-width:700px;margin:40px auto;background:rgba(0,0,0,0.4);padding:25px;border-radius:20px;backdrop-filter:blur(10px);box-shadow:0 0 25px #00eaff;text-align:center;}
...
<div class="hero-text">Explore the breathtaking mountains, serene valleys, and unforgettable adventures of Astore! Your journey starts here.</div>
<button id="logoutBtn" onclick="alert('Thanks for visiting!')"><i class="fa-solid fa-right-from-bracket"></i></button>
...
<label>Phone</label><input type="text" id="rphone" placeholder="03XXXXXXXXX" required>
...
<label>Phone</label><input type="text" id="cphone" placeholder="03XXXXXXXXX" required>
...
<p>Email: <a href="mailto:mohammadasimkhan2746@gmail.com" style="color:#00eaff;">mohammadasimkhan2746@gmail.com</a></p>
<p>WhatsApp: <a href="https://wa.me/923171588489" style="color:#00eaff;">03171588489</a></p>
<p>Facebook: <a href="https://www.facebook.com/share/1BoG9YCsZN/?mibextid=wwXIfr" target="_blank" style="color:#00eaff;">Visit our page</a></p>
</div>
