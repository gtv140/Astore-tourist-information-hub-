...
#logoutBtn{
  position:fixed;bottom:60px;right:20px;padding:14px;font-size:22px;background:#ff4444;border:none;border-radius:50%;box-shadow:0 0 20px #ff6666;color:#fff;cursor:pointer;z-index:999;transition:0.3s;
}
#logoutBtn:hover{transform:scale(1.1);}
.whatsapp-btn{position:fixed;bottom:120px;right:20px;background:#25d366;padding:16px 18px;border-radius:50%;color:#fff;font-size:28px;text-decoration:none;box-shadow:0 0 20px #25d366;transition:0.3s, box-shadow 0.5s;}
